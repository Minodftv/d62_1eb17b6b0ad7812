...
<body>
          ...
          <div class="cf-column">
            ...
            <p>
              <form action="/cdn-cgi/phish-bypass" method="GET">
                <input type="hidden" name="atok" value="xKhML.0ZTwg4ER7uVVlBFQ5rQRQpMlO2XnZ_iv80oVA-1710574750-0.0.1.1-/get/osVCRoIV/d56e21_f1a0e.js">
  ...
  <p class="text-13">
    <span class="cf-footer-item sm:block sm:mb-1">Cloudflare Ray ID: <strong class="font-semibold">8653167fbea98865</strong></span>
    <span class="cf-footer-separator sm:hidden">&bull;</span>
    <span id="cf-footer-item-ip" class="cf-footer-item hidden sm:block sm:mb-1">
      Your IP:
      <button type="button" id="cf-footer-ip-reveal" class="cf-footer-ip-reveal-btn">Click to reveal</button>
      <span class="hidden" id="cf-footer-ip">216.151.184.143</span>
      <span class="cf-footer-separator sm:hidden">&bull;</span>
    </span>
